...
- [ ] 3. Phase 2: Extract Systems (2-3 weeks)
  ...
  - [ ] 3.4 Extract ShopSystem (3-4 days)
    - [ ] 3.4.1 Create ShopSystem file and interface
    ...
    - [ ] 3.4.2 Extract shop refresh and generation logic
    ...
    - [ ] 3.4.3 Extract buy and sell logic
